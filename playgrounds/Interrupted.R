...
beforeNaive <- ds_linear[ds_linear$StageID==1, "BirthRate", ]
afterNaive <- ds_linear[ds_linear$StageID==2, "BirthRate", ]
...
beforeClassic <- seasonalClassic$trend[ds_linear$StageID==1]
afterClassic <- seasonalClassic$trend[ds_linear$StageID==2]
...
beforeLoess <- seasonalLoess$time.series[ds_linear$StageID==1, 2]
afterLoess <- seasonalLoess$time.series[ds_linear$StageID==2, 2]
...
step <- c(rep(0, times=sum(ds_linear$StageID==1)-lag), rep(1, times=sum(ds_linear$StageID==2)))
