...
```{r fig-2-individual-basic}
# ds_linear_all <- utils::read.csv("./Datasets/county_month_birth_rate_2005_version.csv")
...
```{r fig-2-stylized, fig.height = 4.8}
...
```{r fig-5, fig.height = 3, fig.width = 3, out.width="300px"}
...
```{r fig-7-all-counties, fig.height = 6.5 * 12/5}
