...
dsLinearTulsa <- AugmentYearDataWithMonthResolution(dsLinear=portfolioCartesianTulsa$dsLinear, dateName="Date")
dsLinearOk <- AugmentYearDataWithMonthResolution(dsLinear=portfolioCartesianOk$dsLinear, dateName="Date")
dsLinearCleveland <- AugmentYearDataWithMonthResolution(dsLinear=portfolioCartesianCleveland$dsLinear, dateName="Date")
dsLinearComanche <- AugmentYearDataWithMonthResolution(dsLinear=portfolioCartesianComanche$dsLinear, dateName="Date")

#Define the polar properties of the counties
portfolioPolarTulsa <- PolarizeCartesian(dsLinear=portfolioCartesianTulsa$dsLinear, dsStageCycle=portfolioCartesianTulsa$dsStageCycle, yName="BirthRate", stageIDName="StageID", plottedPointCountPerCycle=7200)
portfolioPolarOk <- PolarizeCartesian(dsLinear=portfolioCartesianOk$dsLinear, dsStageCycle=portfolioCartesianOk$dsStageCycle, yName="BirthRate", stageIDName="StageID", plottedPointCountPerCycle=7200)
portfolioPolarCleveland <- PolarizeCartesian(dsLinear=portfolioCartesianCleveland$dsLinear, dsStageCycle=portfolioCartesianCleveland$dsStageCycle, yName="BirthRate", stageIDName="StageID", plottedPointCountPerCycle=7200)
portfolioPolarComanche <- PolarizeCartesian(dsLinear=portfolioCartesianComanche$dsLinear, dsStageCycle=portfolioCartesianComanche$dsStageCycle, yName="BirthRate", stageIDName="StageID", plottedPointCountPerCycle=7200)

cartesianPeriodicTulsa <- CartesianPeriodic(portfolioCartesianTulsa$dsLinear, portfolioCartesianTulsa$dsPeriodic, xName="Date", yName="BirthRate", stageIDName="StageID", changePoints=changeMonth, changePointLabels="Bombing Effect", yTitle="General Fertility Rate", drawPeriodicBand=TRUE)

cartesianPeriodicOk <- CartesianPeriodic(portfolioCartesianOk$dsLinear, portfolioCartesianOk$dsPeriodic, xName="Date", yName="BirthRate", stageIDName="StageID", changePoints=changeMonth, changePointLabels="Bombing Effect", yTitle="General Fertility Rate", drawPeriodicBand=TRUE)

cartesianPeriodicCleveland <- CartesianPeriodic(portfolioCartesianCleveland$dsLinear, portfolioCartesianCleveland$dsPeriodic, xName="Date", yName="BirthRate", stageIDName="StageID", changePoints=changeMonth, changePointLabels="Bombing Effect", yTitle="General Fertility Rate", drawPeriodicBand=TRUE)

cartesianPeriodicComanche <- CartesianPeriodic(portfolioCartesianComanche$dsLinear, portfolioCartesianComanche$dsPeriodic, xName="Date", yName="BirthRate", stageIDName="StageID", changePoints=changeMonth, changePointLabels="Bombing Effect", yTitle="General Fertility Rate", drawPeriodicBand=TRUE)
