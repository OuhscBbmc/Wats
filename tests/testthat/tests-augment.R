...
#   dsBirthRate$StageID <- ifelse(dsBirthRate$Date < changeMonth, 1L, 2L)
  ...
  expect_equal(actual$TerminalPointInCycle, expected=rep(c(FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,TRUE), time=10), label="The `TerminalPointInCycle` should be correct.")
