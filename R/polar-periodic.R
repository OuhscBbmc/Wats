...
polar_periodic <- function(ds_linear, ds_stage_cycle_polar,
  ...
  testit::assert("The `ds_stage_cycle_polar` must have a valid column called `polar_lower_x`.  Typically this is generated by `Wats::polarize_cartesian()`.", !is.null(ds_stage_cycle_polar$polar_lower_x))
  testit::assert("The `ds_stage_cycle_polar` must have a valid column called `polar_lower_y`.  Typically this is generated by `Wats::polarize_cartesian()`.", !is.null(ds_stage_cycle_polar$polar_lower_y))
  testit::assert("The `ds_stage_cycle_polar` must have a valid column called `polar_upper_x`.  Typically this is generated by `Wats::polarize_cartesian()`.", !is.null(ds_stage_cycle_polar$polar_upper_x))
  testit::assert("The `ds_stage_cycle_polar` must have a valid column called `polar_upper_y`.  Typically this is generated by `Wats::polarize_cartesian()`.", !is.null(ds_stage_cycle_polar$polar_upper_y))
...
#     g_observed <- grid::polylineGrob(x=ds_linear$observed_x, y=ds_linear$observed_y, id=ds_linear$stage_id,
...
#     grid::grid.draw(g_observed)
    for (stage in stages) {
      ...
      g_observed <- grid::polylineGrob(x=ds_stage$observed_x, y=ds_stage$observed_y,
