...
# dsLinear <- utils::read.csv("./Datasets/county_month_birth_rate_2014_version.csv", stringsAsFactors=FALSE)
...
portfolioCartesian <- Wats::annotate_data(dsLinear, dvName="BirthRate", centerFunction=stats::median, spreadFunction=hSpread)
